    ...
    <form action="" enctype="multipart/form-data" method="post">
        ...
        <table align="center" width="500" border="0">
            ...
            <tr align="center">
                <th>Remove</th>
                <th>Product(s)</th>
                <th>Total Price</th> <!-- Removed Quantity column header -->
            </tr>
            ...
            <tr align="center">
                <td colspan="2"><input type="submit" name="delete_cart" value="Delete selected"></td>
                <td><a href="complete_checkout.php"><input type="button" value="Continue Checkout"></a></td>
            </tr>
...
<div class="right_content">
    <div class="shopping_cart">
        ...
        <div class="cart_icon"><a href="cart.php" title="header=[Checkout] body=[&nbsp;] fade=[on]"><img src="images/keranjang.png" alt="" width="48" height="48" border="0" /></a></div>
    </div>
...
<!-- end of main content -->
<div class="footer">
    <div class="left_footer"> <img src="images/weblogo.png" alt="" width="170" height="49"/> </div>
